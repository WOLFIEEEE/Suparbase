...
import { ArrowRight, CreditCard, KeyRound, Sparkles, UserCog } from "lucide-react";
...
const ITEMS = [
  ...
  },
  {
    ...
    icon: KeyRound,
    title: "API tokens",
    body: "Personal tokens for the read-only public API: list connections, pull activity, run SELECTs from scripts and CI.",
  },
  {
